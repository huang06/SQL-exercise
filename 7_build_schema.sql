...
INSERT INTO Client (AccountNumber,Name)
...
INSERT INTO Employee (EmployeeID,Name,Position,Salary,Remarks)
VALUES (1, 'Phillip J. Fry', 'Delivery boy', 7500.0, 'Not to be confused with the Philip J. Fry from Hovering Squid World 97a'),
...
INSERT Planet (PlanetID, Name, Coordinates)
VALUES (1, 'Omicron Persei 8', 89475345.3545),
...
INSERT Has_Clearance (Employee,Planet,Level)
VALUES (1, 1, 2),
       (1, 2, 3),
       (2, 3, 2),
       (2, 4, 4),
...
VALUES (1, '3004/05/11', 1, 1),
       (2, '3004/05/11', 1, 2),
       (3, NULL, 2, 3),
       (4, NULL, 2, 4),
       (5, NULL, 7, 5);

INSERT Package (Shipment,PackageNumber,Contents,Weight,Sender,Recipient)
VALUES (1, 1, 'Undeclared', 1.5, 1, 2),
